...
describe('Deep Merge testing', () => {
	...
	it('4. Ожидает, что [] и [] с примитивами будут равны новому массиву', () => {
		expect(
			deepMerge(
	...
	it('5. Ожидается массив глубокого слияния с копией', () => {
	...
	it('6. ожидает объекты глубокого слияния', () => {
		expect(
		...
		expect(
			deepMerge({ a: 1, c: { j: 1, b: 2 }, f: 45 }, { a: 5, b: 6, c: { j: 2, h: 7 } })
		).to.deep.equal(
			{ a: 5, b: 6, c:  { j: 2, b: 2, h: 7 }, f: 45 }
		);
	...
	it('7. Ожидается глубокое слияние объектов с копией', () => {
